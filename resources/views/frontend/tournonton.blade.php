...
@section('content')
    ...
    <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url({{asset('roberto/img/bg-img/IMG_20191018_134630.jpg')}});">
        <div class="container h-100">
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Tour Visit + Nonton</h2>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-room-details-area mb-50">
                            ...
                            <div id="room-thumbnail--slide" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="{{asset('roberto/img/bg-img/IMG_20191018_134630.jpg')}}" class="d-block w-100" alt="">
                                    </div>
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-check"></i> Nonton Bareng di Studio SMK RUS</li>
                        </ul>
